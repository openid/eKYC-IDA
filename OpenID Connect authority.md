...
|`last_accounts_date`|String|A reference date in [@!ISO8601-2004] YYYY-MM-DD format that is used to represent the date of incorporation of the legal entity|
...
...
   ...
   "tauthority_permissions_supported":[
     "Director",
     "Finance Officer",
     "Member of Staff"
   ],
...
```
{
   "verified_claims":{
      "verification":{
        "trust_framework": "uk_company_idp_framework_level_2",
        "time":"2012-04-23T18:25Z"
      },
      "claims":{
        "date_of_incorporation": "1988-06-23",
        "has_been_liquidated": false,
        "company_name": "TESTDATA INC",
        "trading_name": [ "Testdata services", "Data testing services", "sandboxdata.com" ],
        "company_number": "01375041",
        ...
        "accounts": {
            ...
            "last_accounts": {
                "type": "dormant",
                "period_start_on": "2018-06-25",
                "period_end_on": "2019-06-24",
                "made_up_to": "2019-06-24"
            },
            "next_accounts": {
                "overdue": false,
                "due_on": "2021-04-24"
...
## Additional claims about relationships
...
```
{
    ...
    "start_index": 0,
    "links": {
        "self": "/company/01375041/officers"
    },
    "inactive_count": 0,
    "total_results": 3,
    "items": [
        {
            "name": "TEW, Frances Margaret",
            "address": {
                "locality": "London",
                "address_line_1": "30 Hendrick Avenue",
                "address_line_2": "Balham",
                "postal_code": "SW12 8TL"
            },
            "nationality": "British",
            "links": {
                "officer": {
                    "appointments": "/officers/mazU_tbDExUY-pOemj24SHp6l7U/appointments"
                }
            },
        ...
        },
        {
            ...
            "links": {
                "officer": {
                    "appointments": "/officers/4VtZvhNNI8f7UlQxkaB03NtxZ38/appointments"
                }
            }
        },
        {
    ...
    "etag": "16ea5507bdd279bfe6983be73ce2ef46ade835ae"
}
...
"Please provide verified claims for person, authority, company"
...
courts - director of company ion administfration - administrator needs to authorise some act


patent letter
patent author may delegate patent to company




define legal entity... "a company or organization that has legal rights and responsibilities"
...
bootstrap - matter of public record in most jurisdictions for directors and/or persons of significant control 

more difficult if the authority is delegated to another human actor via a chain of authority - is there multi-stage process to extract 


assumption that we are communicating the authority collected within governance framework of ... 

such as dutch mandate register - crypto chain of custody


human actor-

only those two entities will be covered in a single request and response

this entity (1) has the authority to act in this manner on behalf of that entity (2)
...
- the act 
  - spend money
  - speak as company rep in public
  - power of attourney
  - officially report
- financial
  - Budget
  - Functional limitation (tax data or staff concerns)
- time/date
- geography
...
?? code napoleonique
?? islamic tort law - saudi & pakistan
...
# Acknowledgements {#acknowledgements}
The authors would like to acknowledge Taylor Ongaro, ............. for their vital support.
