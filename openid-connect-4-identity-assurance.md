...
`country_code`: country part of an address represented using an ICAO 3-letter code [@!ICAO-Doc9303], e.g. "USA" or "JPN". 2-letter ICAO codes MAY be used in some circumstances for compatibility reasons. `country_code` may be used as alternative to the exting `country` field. 
