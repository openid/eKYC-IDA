%%%
title = "OpenID Connect for Identity Assurance Claims Registration 1.0 - draft 03 incorporating errata set 1"
...
value = "openid-connect-4-ida-claims-1_0-03"
...
|`nationalities`| array | End-user’s nationalities using [@!ISO3166-1] Alpha-3 codes or [@!ICAO-Doc9303] 3-letter codes. ISO Alpha-2 codes or ICAO 2-letter codes may be used in some circumstances for compatibility reasons. Note: [@!ICAO-Doc9303] refers to [@!ISO3166-1] and only the codes not in ISO3166 are defined in the ICAO doc. |
